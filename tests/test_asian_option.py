...
def test_asian_call_reasonable_bounds_vs_european():
    ...
    euro = mc_price_european_vanilla(
        p, "call", n_paths=n_paths, seed=seed, antithetic=True
    )
    asian = mc_price_asian_arithmetic(
        p, "call", n_paths=n_paths, n_steps=50, seed=seed, antithetic=True
    )
...
def test_asian_price_increases_with_spot():
    ...
    a1 = mc_price_asian_arithmetic(
        p1, "call", n_paths=n_paths, n_steps=50, seed=seed, antithetic=True
    )
    a2 = mc_price_asian_arithmetic(
        p2, "call", n_paths=n_paths, n_steps=50, seed=seed, antithetic=True
    )
